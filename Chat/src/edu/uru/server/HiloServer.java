...
public class HiloServer extends Thread {
	...
	public HiloServer(String url, String user, String password, String usuario, String fecha, String path, String valorRandom, Connection conn, Statement st, String teclado, JTextField Textfield, int valorDado) {
		this.url = url;
		this.user = user;
